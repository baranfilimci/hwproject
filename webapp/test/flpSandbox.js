		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Homework 2",
									"targetURL": "#comnttsmhwproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnttsmhwproject-display": {
								"semanticObject": "comnttsmhwproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ntt.sm.hwproject",
									"url": sap.ui.require.toUrl("com/ntt/sm/hwproject")
								}
							}
						}
					}
